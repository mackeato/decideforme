...
import { generateRandomDecision, generateModeDecision, parseUrlParams } from './utils/decision';
...
function App() {
  ...
  const renderModeComponent = () => {
    switch (mode) {
      case 'coin':
        return <CoinFlip onDecide={() => handleDecide()} isLoading={isLoading} />;
      case 'dice':
        return <DiceRoll onDecide={() => handleDecide()} isLoading={isLoading} />;
      case 'wheel':
        return <LuckyWheel onDecide={() => handleDecide()} isLoading={isLoading} />;
      default:
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <footer className="text-center mt-8 text-gray-500 text-sm">
          ...
          <p>Built with ❤️ • <a href="#" className="hover:text-gray-700 transition-colors">GitHub</a> • <a href="#" className="hover:text-gray-700 transition-colors">Feedback</a></p>
        </footer>
      </div>
    </div>
  );
